...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "st_cnn2d_handposture_8classes"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0x42ef97df0047333c87bc4770f595dcb7"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0x3538e359eeeba9ee)
...
#define STAI_NETWORK_IN_1_SHAPE       {1,8,8,2}
...
#define STAI_NETWORK_IN_1_SIZE        (128)
#define STAI_NETWORK_IN_1_SIZE_BYTES  (512)
...
#define STAI_NETWORK_ACTIVATIONS_SIZE              (1672)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (1672)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (1672)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (1672)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (11008)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (11008)
#define STAI_NETWORK_WEIGHTS_ALIGNMENTS \
  { 4,4,4,4,4,4}
#define STAI_NETWORK_WEIGHTS_SIZES \
  { 576,32,9216,128,1024,32}
#define STAI_NETWORK_WEIGHTS_NUM        (6)
#define STAI_NETWORK_WEIGHT_1_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_1_SIZE        (576)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (576)
...
#define STAI_NETWORK_WEIGHT_3_SIZE        (9216)
#define STAI_NETWORK_WEIGHT_3_SIZE_BYTES  (9216)
...
#define STAI_NETWORK_WEIGHT_5_SIZE        (1024)
#define STAI_NETWORK_WEIGHT_5_SIZE_BYTES  (1024)
#define STAI_NETWORK_WEIGHT_6_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_6_SIZE        (32)
#define STAI_NETWORK_WEIGHT_6_SIZE_BYTES  (32)
