...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0x42ef97df0047333c87bc4770f595dcb7"
#define _STAI_NETWORK_DATETIME            "2026-03-09T20:12:55+0000"
...
static const stai_network_info g_network_info = {
  ...
  .activations = (stai_tensor[STAI_NETWORK_ACTIVATIONS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 1672),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  ...
  stai_network* network)
{
...

  {
    const _stai_network_context _network_context = {
      ...
      ._weights = {
      (stai_ptr)g_network_conv2d_weights_array,(stai_ptr)g_network_conv2d_bias_array,(stai_ptr)g_network_dense_dense_weights_array,(stai_ptr)g_network_dense_dense_bias_array,(stai_ptr)g_network_dense_1_dense_weights_array,(stai_ptr)g_network_dense_1_dense_bias_array
      },
      ._inputs = {
    NULL},
      ._outputs = {
...
void forward_lite_mp_max_pooling2d(_stai_network_context* net_ctx)
{
  ...
  max_pooling2d_output_array.data = AI_PTR(net_ctx->_activations[0] + 1152);
  max_pooling2d_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 1152);
...
static const ai_u32 conv2d_t_in_0_shape_ch_const_u32 = 2;
static const ai_u32 conv2d_t_out_0_shape_ch_const_u32 = 8;
static const ai_u32 conv2d_t_in_0_shape_w_const_u32 = 8;
static const ai_u32 conv2d_t_in_0_shape_h_const_u32 = 8;
static const ai_u32 conv2d_t_out_0_shape_w_const_u32 = 6;
static const ai_u32 conv2d_t_out_0_shape_h_const_u32 = 6;
...
static const ai_i32 activation_t_in_0_shape_ch_h_w_prod_const_s32 = 288;
...
static const ai_i32 dense_1_t_in_0_shape_ch_prod_const_s32 = 8;
STAI_API_ENTRY
  ...
  const stai_run_mode mode)
{
  ...
  /* LITE_KERNEL_SECTION BEGIN conv2d */
  {
    ...
    ai_float* conv2d_t_out_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 0);
    const ai_u8* conv2d_t_weight_0_ptr_const_u8 = (ai_u8*)(net_ctx->_weights[0] + 0);
    const ai_u8* conv2d_t_weight_1_ptr_const_u8 = (ai_u8*)(net_ctx->_weights[1] + 0);
    ai_float* conv2d_t_scratch_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 1600);
  ...
  {
      ai_handle activation_t_out_0_ptr_handle = (ai_handle)(net_ctx->_activations[0] + 0);
  ...
  /* LITE_KERNEL_SECTION BEGIN dense_dense */
  {
      ...
      .input = (float*)(net_ctx->_activations[0] + 1152),
  ...
  _STAI_NETWORK_EVENT_NODE_START_CB(6, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 1152)});
  ...
  _STAI_NETWORK_EVENT_NODE_START_CB(6, 1, {(stai_ptr) dense_t_in_0_ptr_const_handle});
  ...
  _STAI_NETWORK_EVENT_NODE_STOP_CB(6, 1, {(stai_ptr) dense_t_out_0_ptr_handle});
  }
  ...
  _STAI_NETWORK_EVENT_NODE_START_CB(7, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 128)});
    
  forward_lite_dense_if32of32wf32((forward_lite_dense_if32of32wf32_args*)&arg_30f51e);
    
  _STAI_NETWORK_EVENT_NODE_STOP_CB(7, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 0)});
  }
  ...
  forward_lite_nl_softmax_if32of32(dense_1_t_out_0_ptr_handle, dense_1_t_in_0_ptr_const_handle, dense_1_t_in_0_shape_ch_prod_const_s32, 1, 8);
...
const uintptr_t _activations_alignment[] = STAI_NETWORK_ACTIVATIONS_ALIGNMENTS;
  ...
  net_ctx->_inputs[0] = activations[0] + 1088;
