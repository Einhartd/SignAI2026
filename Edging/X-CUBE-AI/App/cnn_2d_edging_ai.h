/**
  ...
  ******************************************************************************
  */
#ifndef AI_CNN_2D_EDGING_AI_H
#define AI_CNN_2D_EDGING_AI_H

#include "cnn_2d_edging_ai_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_CNN_2D_EDGING_AI_MODEL_NAME          "cnn_2d_edging_ai"
#define AI_CNN_2D_EDGING_AI_ORIGIN_MODEL_NAME   "st_cnn2d_handposture_8classes"

/******************************************************************************/
#define AI_CNN_2D_EDGING_AI_ACTIVATIONS_ALIGNMENT   (4)
#define AI_CNN_2D_EDGING_AI_INPUTS_IN_ACTIVATIONS   (4)
#define AI_CNN_2D_EDGING_AI_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_CNN_2D_EDGING_AI_IN_NUM        (1)

AI_DEPRECATED
#define AI_CNN_2D_EDGING_AI_IN \
  ai_cnn_2d_edging_ai_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_CNN_2D_EDGING_AI_IN_SIZE { \
  AI_CNN_2D_EDGING_AI_IN_1_SIZE, \
}
#define AI_CNN_2D_EDGING_AI_IN_SIZE_BYTES { \
  AI_CNN_2D_EDGING_AI_IN_1_SIZE_BYTES, \
}
#define AI_CNN_2D_EDGING_AI_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_CNN_2D_EDGING_AI_IN_1_HEIGHT      (8)
#define AI_CNN_2D_EDGING_AI_IN_1_WIDTH       (8)
#define AI_CNN_2D_EDGING_AI_IN_1_CHANNEL     (2)
#define AI_CNN_2D_EDGING_AI_IN_1_SIZE        (128)
#define AI_CNN_2D_EDGING_AI_IN_1_SIZE_BYTES  (512)

/******************************************************************************/
#define AI_CNN_2D_EDGING_AI_OUT_NUM       (1)

AI_DEPRECATED
#define AI_CNN_2D_EDGING_AI_OUT \
  ai_cnn_2d_edging_ai_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_CNN_2D_EDGING_AI_OUT_SIZE { \
  AI_CNN_2D_EDGING_AI_OUT_1_SIZE, \
}
#define AI_CNN_2D_EDGING_AI_OUT_SIZE_BYTES { \
  AI_CNN_2D_EDGING_AI_OUT_1_SIZE_BYTES, \
}
#define AI_CNN_2D_EDGING_AI_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_CNN_2D_EDGING_AI_OUT_1_CHANNEL     (8)
#define AI_CNN_2D_EDGING_AI_OUT_1_SIZE        (8)
#define AI_CNN_2D_EDGING_AI_OUT_1_SIZE_BYTES  (32)

/******************************************************************************/
#define AI_CNN_2D_EDGING_AI_N_NODES (5)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup cnn_2d_edging_ai
 ...
 * @ref ai_cnn_2d_edging_ai_create. Both the activations memory buffer 
 ...
 * using @ref ai_cnn_2d_edging_ai_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_cnn_2d_edging_ai_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_cnn_2d_edging_ai_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_CNN_2D_EDGING_AI_*
 * defines into file @ref cnn_2d_edging_ai.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_cnn_2d_edging_ai_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_CNN_2D_EDGING_AI_H */
